...
RcppExport SEXP _softmatrix_phi_app(SEXP X_standSEXP, SEXP ancSEXP, SEXP tauSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_softmatrix_phi_app", (DL_FUNC) &_softmatrix_phi_app, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_softmatrix(DllInfo *dll) {
